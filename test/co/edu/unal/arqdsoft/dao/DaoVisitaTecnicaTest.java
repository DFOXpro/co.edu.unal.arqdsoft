...
//        ReporteDano reporteDano = daoReporteDano.getReporte(1);
//
//        VisitaTecnica visitaTecnica = new VisitaTecnica(null, new Date(2012, 02, 20), reporteDano, "calle falsa 543");
//
//        DaoVisitaTecnica daoVisitaTecnica = new DaoVisitaTecnica();
//
...
//        System.out.println(DaoVisitaTecnica.obtenerVisitasPorTecnico(2).get(0).getTecnico().getNombre());
//    }
    
    @Test
    public void testObtenerVisitasSinTecnico() {
        System.out.println("obtenerVisitasPorTecnico");
        System.out.println(DaoVisitaTecnica.obtenerVisitasSinTecnico().get(0).getId());
    }
